...
const styles = StyleSheet.create({
    mainview:{borderBottomWidth:1,borderColor:Colors.lineseprator,paddingVertical:10},
    rowview:{
        flexDirection:'row',
    ...
    nametxt:{fontSize:20,marginLeft:10,fontWeight:'bold',color:Colors.balckText}
