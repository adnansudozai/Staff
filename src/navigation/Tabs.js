...
const CustomTabBarButton=({children,onPress})=>{
    return(
<TouchableOpacity
style={{top:Platform.OS=='ios'?-40:-55,
...
<Tab.Navigator initialRouteName='Inbox' screenOptions={{
    ...
    tabBarStyle: {
        backgroundColor: Colors.tabviewbordercolor, position: 'absolute',  borderTopWidth: 0, height: hp(9.8), borderTopLeftRadius: 20,
                   borderTopRightRadius: 20,paddingTop:hp(4)
     },
    ...
    <Tab.Screen name='Inbox' component={Inbox} options={{
        ...
        tabBarIcon: ({ focused }) => (
            ...
            <View style={styles.mainview}>
                ...
                <Text style={{...styles.labeltext,color:Colors.textColorWhite,}}>Inbox</Text>
               
                </View>
                :
                <View style={styles.mainview}>
                <Image source={Images.inbox} style={styles.icons}  />
                <Text style={{...styles.labeltext,color:Colors.inactivetext,}}>Inbox</Text>
...
options={{
   ...
   tabBarIcon: ({ focused }) => (
       ...
       <View style={styles.mainview}>
           ...
           <Text style={{...styles.labeltext,color:Colors.textColorWhite,}}>Schedule</Text>
          
           </View>
           :
           <View style={styles.mainview}>
           <Image source={Images.Schedule} style={styles.icons}  />
           <Text style={{...styles.labeltext,color:Colors.inactivetext,}}>Schedule</Text>
   ...
   component={Patient} options={{
        ...
        <View style={styles.mainview}>
            ...
            <Text style={{...styles.labeltext,color:Colors.textColorWhite,}}>Patient</Text>
           
            </View>
            :
            <View style={styles.mainview}>
            <Image source={Images.Patient} style={styles.icons}  />
            <Text style={{...styles.labeltext,color:Colors.inactivetext}}>Patient</Text>
...
const styles = StyleSheet.create({
    ...
    mainview:{borderWidth:0,borderColor:'red',alignItems:'center',justifyContent:'space-between',alignSelf:'center'},
